...
const courses = [
  {
    ...
    students: 4000,
    lessons: 20,
    hours: "26 Hours (7 Live Sessions)",
    level: "Beginner Friendly",
    language: "English & Sinhala",
    tags: ["SkillLift Instructors", "Crypto Trading"],
    ...
    accent: "#1a56db",
    desc: "A practical, beginner-friendly programme covering crypto market fundamentals, technical analysis, trading tools, risk management and disciplined decision-making — through personal coaching or live small-group classes.",
  },
  {
    id: "korean-language",
