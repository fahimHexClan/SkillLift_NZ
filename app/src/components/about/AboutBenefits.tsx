...
const benefits = [
  {
    ...
    desc: "Clear guidance from trainers with relevant subject knowledge in crypto markets and trading.",
    accent: "#1a56db",
  },
  {
    icon: Video,
    ...
    desc: "Personal coaching and small-group options for different schedules and time zones.",
    accent: "#1a56db",
  },
  {
    icon: Wallet,
    ...
    desc: "Examples, exercises and tools connected to real learning situations, not just theory.",
    accent: "#1a56db",
  },
  {
    icon: Infinity,
    num: "04",
    title: "Recorded Resources & LMS",
    desc: "Materials that support revision between live sessions, available whenever you need them.",
    accent: "#0ea5e9",
  },
];
